...
import { getContext, executeAsync } from 'file://D:/dev/Web%20Projects/oursite/nuxt/node_modules/unctx/dist/index.mjs';
import { sanitizeStatusCode, createError as createError$1 } from 'file://D:/dev/Web%20Projects/oursite/nuxt/node_modules/h3/dist/index.mjs';
import { useRoute as useRoute$1, RouterView, createMemoryHistory, createRouter, START_LOCATION } from 'file://D:/dev/Web%20Projects/oursite/nuxt/node_modules/vue-router/vue-router.node.mjs';
import { toRouteMatcher, createRouter as createRouter$1 } from 'file://D:/dev/Web%20Projects/oursite/nuxt/node_modules/radix3/dist/index.mjs';
import { defu } from 'file://D:/dev/Web%20Projects/oursite/nuxt/node_modules/defu/dist/defu.mjs';
import { hasProtocol, isScriptProtocol, joinURL, withQuery } from 'file://D:/dev/Web%20Projects/oursite/nuxt/node_modules/ufo/dist/index.mjs';
import { ssrRenderSuspense, ssrRenderComponent, ssrRenderVNode } from 'file://D:/dev/Web%20Projects/oursite/nuxt/node_modules/vue/server-renderer/index.mjs';
...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import('./index-U15eEOv0.mjs')
  },
  {
    name: "Businesses",
    path: "/Businesses",
    component: () => import('./Businesses-v9VIZKqs.mjs')
  }
];
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-B2l6ASK2.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-QGYqMg6m.mjs'));
